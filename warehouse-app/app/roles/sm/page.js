...
export default function StoreManagerApp() {
  ...
  const isSlaBreached = avgPickSec > 180; // > 3 mins
  ...
  // Trigger Notification Sound on SLA breach or High Incident
  useEffect(() => {
    if (isSlaBreached) {
  ...
  // Flag DAD Item for Investigation
